...
//
// replace github.com/dapr/components-contrib => ../comp_3
replace github.com/dapr/components-contrib => github.com/DeepanshuA/components-contrib v1.6.0-rc.2.0.20220926064515-bee578ae1867
