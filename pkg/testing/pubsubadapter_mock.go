...
type MockPubSubAdapter struct {
	...
	BatchPublishFn func(req *pubsub.BatchPublishRequest) error
...
// And then forward them to the Pub/Sub component.
// This method is used by the HTTP and gRPC APIs.
func (a *MockPubSubAdapter) BatchPublish(req *pubsub.BatchPublishRequest) error {
	return a.BatchPublishFn(req)
}
