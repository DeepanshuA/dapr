...
type DaprClient interface {
	...
	PublishBatchEvent(ctx context.Context, in *BatchPublishRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *daprClient) PublishBatchEvent(ctx context.Context, in *BatchPublishRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
...
type DaprServer interface {
	...
	PublishBatchEvent(context.Context, *BatchPublishRequest) (*emptypb.Empty, error)
	// Invokes binding data to specific output bindings
...
func (UnimplementedDaprServer) PublishBatchEvent(context.Context, *BatchPublishRequest) (*emptypb.Empty, error) {
...
func _Dapr_PublishBatchEvent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DaprServer).PublishBatchEvent(ctx, req.(*BatchPublishRequest))
	}
	return interceptor(ctx, in, info, handler)
}
